...
import com.practica.libros.servicios.AutoIncrementLibroService;


@RestController
@CrossOrigin(origins = {"http://localhost:4200", "http://frontend:80"}) // Permite solicitudes desde Angular
public class ApiLibrosAngularController {
    
    @Autowired
    private LibroRepo libroRepo;

    @Autowired
    private AutoIncrementLibroService autoIncrementService; //  Inyección de AutoIncrementService para actualizar id despues de cada modificacion
    ...
    @DeleteMapping(value = "/libros/borrar/{id}")
